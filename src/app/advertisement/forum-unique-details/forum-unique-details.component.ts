...
// import { requiredFieldsValidator } from './Validations-forum-unique-details';


@Component({
  selector: 'app-forum-unique-details',
  templateUrl: './forum-unique-details.component.html',
  styleUrls: ['./forum-unique-details.component.css']
})
export class ForumUniqueDetailsComponent implements OnChanges {
  ...
  setValidations(){
    ...
    if(this.selectedCategoryName==='1'){
      ...
      if(this.selectedSubcategoryName !== '7' && this.selectedSubcategoryName !== '8'){this.vehiclesForm.get('yearOfManufacture')?.setValidators([Validators.required])};
    ...
    if(this.selectedCategoryName==='2'){
      //setvalidators
      if(this.selectedSubcategoryName !== '12' && this.selectedSubcategoryName !== '13'){this.propertyForm.get('landSize')?.setValidators([Validators.required])};
      ...
      this.propertyForm.get('address')?.setValidators([Validators.required]);
  ...
  onFormValidityChanged(form: FormGroup) {
    ...
    form.valueChanges.subscribe(() => {
      this.form2ValidityChanged.emit(form.valid);
    });
  }
